...
if __name__ == "__main__":
    ...
    renderer = NerfRenderer(
        #  outputs/1125_multiple_gates/nerfacto/2024-11-25_193859
        '../outputs/test/nerfacto/2025-01-23_150852/config.yml',
    ...
    pose_list = [
        [2, 2, 1, 0, 0, -2.3], # x, y, z, roll, pitch, yaw, gate_flag
        [1, 2, 1, 0, 0, -2],
        [0, 2, 0.8, 0, 0, -1.57],
        [-1, 2, 0.8, 0, 0, -1],
        ...
        # [1.8, 1, 1.2, 0, 0, -1.57],
        # [1, -2.3, 1.2, 0, 0, -3.14],
        # [-3.1, -1.7, 0.9, 0, 0, 1.57],
        # [-1, 2, 0.9, 0, 0, 0]

        # # exact gate location
        # [1.8, 0, 1.1, 0, 0, -1.57],
        # [-0.4, -2.3, 1.1, 0, 0, -3.14],
        # [-3.1, -0.6, 0.8, 0, 0, 1.57],
        # [-0.8, 1.8, 0.8, 0, 0, 0]

    ]

    # with open("./scripts/nerf_state.pickle", 'rb') as file:
    #     try:
    #         count = 0
    #         while True:
    #             data = pickle.load(file) # data = [img, steer], image is 720*1280*3, steer is a numerical value
    #             # image_arr.append(data[0])
    #             # bank_pitch_arr.append(data[1:])
    #             count += 1
    #             # break
    #     except EOFError:
    ...
    for idx, (x, y, z, roll, pitch, yaw) in enumerate(pose_list):
        ...
        plt.show()
        break
        # cv2.imwrite(f"./scripts/4-gates-state-control/a{idx:04d}.png", cv_img)